# BARNES Moscow New Asset Map

Final GitHub Pages base URL:

```text
https://daniilterekh-prog.github.io/barnes-assets/moscow-new/
```

| image key | file | URL template |
|---|---|---|
| `heroBuilding` | `hero-building.webp` | `https://daniilterekh-prog.github.io/barnes-assets/moscow-new/hero-building.webp` |
| `atlasMap` | `atlas-map.webp` | `https://daniilterekh-prog.github.io/barnes-assets/moscow-new/atlas-map.webp` |
| `indexMockup` | `index-mockup.webp` | `https://daniilterekh-prog.github.io/barnes-assets/moscow-new/index-mockup.webp` |
| `finalCta` | `final-cta.webp` | `https://daniilterekh-prog.github.io/barnes-assets/moscow-new/final-cta.webp` |
